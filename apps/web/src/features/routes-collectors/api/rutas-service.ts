...
function buildRutaDetail(item: RutaListItem): RutaDetail {
  return {
    ...
    saldoTotal: 4900000,
    cierres: [
      { id: `${item.id}-cierre-1`, fecha: "20 jul", total: 540000, estado: "CLOSED", creditosNuevos: 2, clientesSinPagar: 3 },
      { id: `${item.id}-cierre-2`, fecha: "19 jul", total: 520000, estado: "CLOSED", creditosNuevos: 1, clientesSinPagar: 4 },
      { id: `${item.id}-cierre-3`, fecha: "18 jul", total: 560000, estado: "CLOSED", creditosNuevos: 0, clientesSinPagar: 2 },
      { id: `${item.id}-cierre-4`, fecha: "17 jul", total: 500000, estado: "CLOSED", creditosNuevos: 3, clientesSinPagar: 5 },
      { id: `${item.id}-cierre-5`, fecha: "16 jul", total: 480000, estado: "CLOSED", creditosNuevos: 1, clientesSinPagar: 1 },
    ],
