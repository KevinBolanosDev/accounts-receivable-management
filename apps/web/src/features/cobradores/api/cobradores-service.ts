...
const MOCK_COBRADORES: CobradorListItem[] = [
  { id: "c2", nombre: "Ana Torres", documento: "1.002.000.002", rol: "COBRADOR", telefono: "302 118 4420", activo: true, rutas: [{ id: "r2", nombre: "Ruta 2 · Sur" }], clientesCount: 22, cobradoHoy: 310000 },
  { id: "c1", nombre: "Carlos Ramírez", documento: "1.001.000.001", rol: "COBRADOR", telefono: "301 445 6789", activo: true, rutas: [{ id: "r3", nombre: "Ruta 3 · Centro" }, { id: "r1", nombre: "Ruta 1 · Norte" }], clientesCount: 62, cobradoHoy: 980000 },
  { id: "c6", nombre: "Diana Reyes", documento: "1.006.000.006", rol: "COBRADOR", telefono: "312 903 5540", activo: false, rutas: [], clientesCount: 0, cobradoHoy: 0 },
  { id: "c5", nombre: "Jorge Peña", documento: "1.005.000.005", rol: "COBRADOR", telefono: "315 660 3311", activo: true, rutas: [{ id: "r6", nombre: "Ruta 6 · Kennedy" }], clientesCount: 15, cobradoHoy: 0 },
  { id: "c4", nombre: "Luis Gómez", documento: "1.004.000.004", rol: "COBRADOR", telefono: "300 774 1265", activo: true, rutas: [{ id: "r4", nombre: "Ruta 4 · Occidente" }], clientesCount: 19, cobradoHoy: 240000 },
  { id: "c3", nombre: "Marta Díaz", documento: "1.003.000.003", rol: "COBRADOR", telefono: "310 552 9087", activo: true, rutas: [{ id: "r5", nombre: "Ruta 5 · Oriente" }], clientesCount: 26, cobradoHoy: 180000 },
];
...
export const httpCobradoresService: CobradoresService = {
  listCobradores() {
    return apiFetch("/usuarios?rol=COBRADOR", cobradorListItemSchema.array());
  },
  async getCobradoresSummary() {
    const cobradores = await apiFetch("/usuarios?rol=COBRADOR", cobradorListItemSchema.array());
    return {
  ...
  createCobrador(body) {
    return apiFetch("/usuarios", cobradorListItemSchema, { method: "POST", body });
  },
  updateCobrador(id, body) {
    return apiFetch(`/usuarios/${id}`, cobradorListItemSchema, { method: "PATCH", body });
  },
};

// Punto de inyección del swap mock→real (sub-fase 2.14). Bloque A: mock.
export const cobradoresService: CobradoresService = mockCobradoresService;
